...
<?php 
                     ...
                     $sql2 = "SELECT * FROM tbl_transaction where fld_transaction='Appointment' and fld_Status='Pending'  ";
    ...
    <tr>
      ...
      <td colspan="4">
          ...
          <p><b>Contact Number:</b> <?php echo $row2['fld_Message'] ?></p>
              <p><b>Service:</b> <?php echo $row2['fld_Service'] ?></p>
...
?>
 ...
 <td colspan="4">
                  <a href="Notify.php?id=<?php echo $fld_Id;?>"class="btn btn-primary btn-block">Notified Via Email</a>
                </td>
